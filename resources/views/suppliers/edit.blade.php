<x-app-layout>
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-500">Edit supplier details</p>
    </div>

    <div class="max-w-4xl mx-auto">
        <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
            <div class="p-6 bg-[#f8fafc] border-b border-gray-100 flex justify-between items-center">
                <h3 class="font-bold text-[#1e293b] uppercase tracking-wider text-sm">Edit Supplier: <span
                        class="text-indigo-600">{{ $supplier->name }}</span></h3>
            </div>

            <form action="{{ route('suppliers.update', $supplier) }}" method="POST" class="p-6 md:p-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name"
                                ...
                                type="text" name="name" :value="old('name', $supplier->name)" required autofocus />
                        ...
                        <div>
                            ...
                            <textarea id="address" name="address" rows="3"
                                class="block mt-1 w-full rounded-lg border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">{{ old('address', $supplier->address) }}</textarea>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="contact_person"
                                class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                                type="text" name="contact_person" :value="old('contact_person', $supplier->contact_person)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="email"
                                class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                                type="email" name="email" :value="old('email', $supplier->email)" />
                        ...
                        <div>
                            ...
                            <x-text-input id="phone"
                                class="block mt-1 w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm transition-colors"
                                type="text" name="phone" :value="old('phone', $supplier->phone)" />
