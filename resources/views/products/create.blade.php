                        ...
                        <div>
                            ...
                            <div class="mt-1 relative rounded-md shadow-sm">
                                <x-text-input id="sku"
                                    ...
                                    type="text" name="sku" :value="old('sku')" required placeholder="GEN-001" />
                            </div>
                            <p class="mt-1 text-xs text-gray-400">Unique Stock Keeping Unit identifier</p>
                        ...
                        <div>
                            ...
                            <select id="type" name="type"
                                ...
                                <option value="raw_material" {{ old('type') == 'raw_material' ? 'selected' : '' }}>Raw
                                    Material</option>
                                <option value="finished_good" {{ old('type') == 'finished_good' ? 'selected' : '' }}>
                        ...
                        <div>
                            ...
                            <div class="relative mt-1 rounded-md shadow-sm">
                                <input type="number" name="min_stock" id="min_stock"
                                    ...
                                    placeholder="10" value="{{ old('min_stock', 10) }}" required />
                                <div class="pointer-events-none absolute inset-y-0 right-0 flex items-center pr-3">
                                    <span class="text-gray-500 sm:text-sm">units</span>
                                </div>
                            </div>
                            <p class="mt-1 text-xs text-gray-400">System will alert when stock falls below this number
                            </p>
